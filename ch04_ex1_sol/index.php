        ...
        <nav>
            <ul>
                <?php foreach ($categories as $category) : ?>
                    <li><a href=".?category_id=<?php echo htmlspecialchars($category['categoryID']); ?>">
                ...
                <tr>
                    ...
                    <td>
                        <form action="delete_product.php" method="post">
                            ...
                            <input type="hidden" name="category_id" value="<?php echo htmlspecialchars($product['categoryID']); ?>">
